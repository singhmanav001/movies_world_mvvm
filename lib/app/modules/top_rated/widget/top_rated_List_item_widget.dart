...
class TopRatedListItem extends StatelessWidget with BaseWidgetMixin {
  final TopRatedController controller = Get.find<TopRatedController>();
  final Movies itemModel;
  final int index;

  TopRatedListItem({required this.index, required this.itemModel, Key? key}) : super(key: key);
  ...
  Widget body(BuildContext context) {
    return Container(
      ...
      child: CustomInkWell(
        id: 'top_rated_item_${itemModel.id}',
        onTap: () {},
        child: Container(
